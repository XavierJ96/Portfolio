        ...
        <div className="about-card">
          ...
          <div>
            <p className="about-description">
              Hello! My name is Xavier Julies. I'm a front-end web developer who
              builds the front-end of websites and web applications. I enjoy
              creating things that live on the internet. Check out some of my
          ...
          <div>
            <p className="about-description tech-text">
