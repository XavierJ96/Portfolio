            ...
            <Link
                ...
                <ul className="nav_list">
                    ...
                    offset={-70}>
                        ...
                        <li className="nav_item"><a href="https://drive.google.com/uc?export=download&id=1NGRIhs0kvdX2tmjmRh4R0MZkX35r-7p9" download="Xavier's CV.pdf" className="nav-links nav_resume">Resume</a></li>
                </ul>
            </div>
            </div>
            { isOpen ? 
