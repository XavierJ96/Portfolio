            ...
            <div className="project-container container">
                ...
                <div className="project-card">
                    <div className="project-img">
                        <img src={props.item.Image} alt="Image of project" className="project1"/>
                    </div>
                    <div className="project-text">
                        ...
                        <div className="projectLink-container">
                            <a href={props.item.gitLink} className="projectLinks git-link" >Github</a>
                            <a href={props.item.live} className="projectLinks live-link" >Live →</a>
                        </div>
                    </div>
                </div>
            </div>
